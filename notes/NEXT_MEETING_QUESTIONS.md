...
13. Given that the global-mean 1° target area lies between H3 resolutions 3 and 4, which H3 resolution should be used for the benchmark comparison, and how should that approximation be justified?
