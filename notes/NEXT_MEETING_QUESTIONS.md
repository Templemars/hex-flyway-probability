...
14. Should we install or enable the preferred Python stack (`pandas`, `numpy`, `matplotlib`, `xarray`, later `h3`) on this machine now so the simple Python implementation can proceed?
