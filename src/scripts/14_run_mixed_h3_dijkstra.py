...
def main() -> None:
    ...
    start_record, end_record = derive_prototype_endpoints(benchmark, env, "first_row_of_gdf_SS_10", "last_row_of_gdf_SS_10")
    ...
    print(f"Running mixed-behavior H3 Dijkstra batch for {n_behaviors} behaviors", flush=True)
