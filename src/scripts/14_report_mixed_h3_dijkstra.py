#!/usr/bin/env python3
"""
Render figures and report for the Svalbard mixed-behavior H3 Dijkstra batch from
saved step-14 outputs only.
"""
...
PATHS_PATH = PROJECT_ROOT / "results" / "tables" / "14_svalbard_mixed_dijkstra_paths.csv"
SUMMARY_PATH = PROJECT_ROOT / "results" / "tables" / "14_svalbard_mixed_dijkstra_summary.csv"
WEIGHTS_PATH = PROJECT_ROOT / "results" / "tables" / "14_svalbard_mixed_dijkstra_weight_sets.csv"
ENDPOINTS_PATH = PROJECT_ROOT / "results" / "tables" / "14_svalbard_mixed_dijkstra_endpoints.csv"
FAILURES_PATH = PROJECT_ROOT / "results" / "tables" / "14_svalbard_mixed_dijkstra_failures.csv"
...
'''
    ...
    print("Rendered Svalbard step-14 report from saved outputs")
